...
PLOTS = [
    ...
    ("insertion_mean_depth_vs_threads.png", "ins_mean", "Mean Overtake Depth", "Insertion Fairness — Mean Depth vs Threads"),
    ...
    ("service_mean_depth_vs_threads.png",   "deq_mean", "Mean Overtake Depth", "Service Fairness — Mean Depth vs Threads"),
    ...
    ("e2e_mean_depth_vs_threads.png",       "e2e_mean", "Mean Overtake Depth", "End-to-End Fairness — Mean Depth vs Threads"),
...
COMBINED = [
    ...
    ("mean_depth_comparison.png",
     ["ins_mean", "deq_mean", "e2e_mean"],
     "Mean Overtake Depth",
